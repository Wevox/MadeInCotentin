	  ...
	  if(responsePromo.statusCode == 200){
		  ...
		  jsonResponse.forEach((element) {
			  ...
			  configData.sales[int.parse(element["id_sale"])] = Sale(
				  ...
				  startDateTime: DateTime.parse(element["start_datetime"]+" 23:59:59"),
			  );
		  });
	  }
	  
	  Navigator.pushReplacement(context, CupertinoPageRoute(builder: (BuildContext context) =>  Scaffold(
